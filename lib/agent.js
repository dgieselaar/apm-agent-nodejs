...
Agent.prototype.sendProfile = function (profileAsBuffer, metadata, cb) {
  this._transport.sendProfile(profileAsBuffer, metadata, cb)
};

Agent.prototype.startCpuProfile = function (name, metadata) {
  return this._profiles.startCpuProfile(name, metadata)
}

Agent.prototype.getHeapProfile = function (name, metadata) {
  return this._profiles.getHeapProfile(name, metadata)
}
